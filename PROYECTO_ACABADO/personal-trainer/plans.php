...
$activePlan = getUserActivePlan($userId);
$trainer = getClientTrainer($userId);
$notificationCount = getUserNotifications($userId);

// Si no hay planes disponibles, crear los planes por defecto
try {
    createDefaultPlans();
                                ...
                                <?php if ($notificationCount > 0): ?>
                                    <div class="text-gray-700">
                                        <div class="flex items-center space-x-2 mb-2 p-2 hover:bg-gray-50 rounded">
                                            ...
                                            <p>Nuevo ejercicio añadido a tu plan</p>
                                        </div>
                                        <div class="flex items-center space-x-2 mb-2 p-2 hover:bg-gray-50 rounded">
                                            <i class="fas fa-star text-primary"></i>
                                            <p>Has completado tu objetivo semanal</p>
                                        </div>
                                        <div class="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded">
                                            <i class="fas fa-chart-line text-primary"></i>
                                            <p>Nuevo récord personal registrado</p>
                                        </div>
                                    </div>
                                <?php else: ?>
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="border border-gray-200 rounded-lg p-6 hover:border-primary transition duration-300">
                        <h4 class="font-bold text-secondary mb-2"><?php echo htmlspecialchars($plan['name']); ?></h4>
                        <p class="text-gray-600 mb-4"><?php echo htmlspecialchars($plan['description']); ?></p>
                        <div class="mb-4">
                            <span class="text-sm text-gray-500">Duración:</span>
                            <span class="text-sm font-medium text-secondary ml-1"><?php echo $plan['duration_weeks']; ?> semanas</span>
                        </div>
                        <div class="mb-4">
                            <span class="text-sm text-gray-500">Entrenador:</span>
                            <span class="text-sm font-medium text-secondary ml-1"><?php echo htmlspecialchars($plan['trainer_name']); ?></span>
                        </div>
                        <a href="plan_details.php?id=<?php echo $plan['id']; ?>" 
                           class="block w-full bg-primary text-white text-center rounded-md py-2 hover:bg-opacity-90 transition duration-300">
                            Ver Detalles
                        </a>
                    </div>
                    <?php endforeach; ?>
